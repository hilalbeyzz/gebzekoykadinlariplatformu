  ...
  if (!post) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-4">
        <div className="bg-white/5 p-12 rounded-2xl shadow-sm border border-secondary/20 text-center max-w-md w-full backdrop-blur-sm">
          ...
          <p className="text-foreground-dark/80 mb-8">
  ...
  return (
    <div className="min-h-screen bg-background-dark py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <article className="bg-white/5 rounded-3xl shadow-sm border border-secondary/20 overflow-hidden backdrop-blur-sm">
          <div className="p-8 sm:p-12">
            <h1 className="text-3xl sm:text-4xl font-bold text-foreground-dark mb-6 leading-tight">
              {post.title}
            </h1>
            
            <div className="flex items-center gap-4 mb-10 pb-10 border-b border-secondary/20">
            ...
            <div className="prose prose-lg max-w-none text-foreground-dark/90 whitespace-pre-wrap leading-relaxed">
              {post.content}
            </div>
          </div>
        </article>
